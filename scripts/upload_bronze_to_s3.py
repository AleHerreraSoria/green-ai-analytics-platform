...
DEFAULT_UPLOADS: list[tuple[str, str]] = [
    ...
    ("data/Our_World_In_Data/owid-energy-data.csv", "owid/owid-energy-data.csv"),
    (
        "data/Global_Petrol_Prices/electricity_prices_by_country_2023_2026_avg.csv",
        "global_petrol_prices/electricity_prices_by_country_2023_2026_avg.csv",
    ),
    (
        "data/World_Bank_Group/API_BX.GSR.CCIS.CD_DS2_en_csv_v2_920.csv",
        "world_bank/API_BX.GSR.CCIS.CD_DS2_en_csv_v2_920.csv",
    ),
    (
        "data/World_Bank_Group/Metadata_Country_API_BX.GSR.CCIS.CD_DS2_en_csv_v2_920.csv",
